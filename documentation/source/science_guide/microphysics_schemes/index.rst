...
cloud and precipitation processes on the grid-scale
(as opposed to those occuring within parameterised convection,
which are represented by the convection scheme).
